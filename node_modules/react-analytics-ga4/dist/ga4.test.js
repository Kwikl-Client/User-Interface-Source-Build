...
describe("GA4", function () {
  ...
  describe("GA4.set()", function () {
    ...
    it("set() with additional params", function () {
      // Given
      var object = ["user_properties", {
      ...
      // When
      _ga["default"].set.apply(_ga["default"], object);

      // Then
      expect(_gtag["default"]).toHaveBeenNthCalledWith(1, "set", "user_properties", {
        favorite_composer: "Mahler",
        favorite_instrument: "double bass",
        season_ticketholder: "true"
      });
