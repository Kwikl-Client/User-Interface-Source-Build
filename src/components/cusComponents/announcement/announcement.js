  ...
  return (
    <div className={isClosed ? "announcement-bar hidden" : "announcement-bar"}>
      <div className="sectimer">
        ...
        <span className='timer-text'>End-of-day special offer</span>
      </div>
      <div className="center-content">
        Unlock <span className='ninty-percentage'>90% </span>Saving <span className={`timer ${secondsTimer < 10 ? 'seconds-timer' : ''}`}>
          {formatTime(timer)}
        </span>
      </div>
